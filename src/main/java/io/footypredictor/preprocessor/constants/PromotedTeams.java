...
public class PromotedTeams {
    ...
    public static final Map<Integer, List<String>> PROMOTED_TEAMS_BY_YEAR = new HashMap<Integer, List<String>>(){{
        put(2019, Arrays.asList("Norwich", "Sheffield United", "Aston Villa", "Luton", "Barnsley", "Charlton", "Lincoln", "Bury", "Milton Keynes Dons", "Tranmere", "Leyton Orient", "Salford", "Osasuna", "Granada", "Mallorca", "Brescia", "Lecce", "Verona", "FC Koln", "Paderborn", "Union Berlin", "Metz", "Brest", "Ross County", "Twente", "Waalwijk", "Sparta Rotterdam"));
        ...
        put(2015, Arrays.asList("Bournemouth", "Watford", "Norwich", "Bristol City", "Milton Keynes Dons", "Preston", "Burton", "Shrewsbury", "Bury", "Southend", "Barnet", "Bristol Rvs", "Betis", "Sp Gijon", "Las Palmas", "Carpi", "Frosinone", "Bologna", "Ingolstadt", "Darmstadt", "Troyes", "Ajaccio GFCO", "Angers", "Hearts", "Nijmegen", "Roda"));
    }};
